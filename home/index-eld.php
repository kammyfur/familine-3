...
<body>
    ...
    <?php else: ?>
        <div id="overlay" style="background-color: rgba(0, 0, 0, .6);"></div>
        <div id="weather" style="display:none;z-index:10;border-radius:10px;padding:8px;position:fixed;top:16px;right:16px;color:white;"><div style="text-align:center;" id="weather-overview"></div><table id="weather-details"><tbody><tr><td class="td1"><b>Ressenti</b></td><td id="weather-feel">...</td></tr><tr><td class="td1"><b>Direction du vent</b></td><td id="weather-wind-dir">...</td></tr><tr><td class="td1"><b>Vitesse du vent</b></td><td id="weather-wind-spd">...</td></tr><tr><td class="td1"><b>Humidité</b></td><td id="weather-humidity">...</td></tr><tr><td class="td1"><b>Nuages</b></td><td id="weather-clouds">...</td></tr><tr><td class="td1"><b>Précipitations</b></td><td id="weather-rain">...</td></tr><tr><td colspan="2" style="text-align:center;display:none;" id="weather-updated">Chargement...</td></tr></tbody></table></div>
        ...
        <div id="container">
            ...
            if (hour < 4) {
                ...
                document.write("Bon début de matinée");
            } else if (hour < 11) {
                document.write("Bonne journée");
            } else if (hour < 14) {
                document.write("Bonne appétit");
            } else if (hour < 18) {
            ...
            <form action="<?php
                ...
                ?>" id="fl-searchfrm">
                <input id="fl-searchbox" name="q" placeholder="Rechercher sur Internet" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
                <button type="submit" id="fl-searchsmb"><img src="https://familine.ddns.net/cdn/material/ic_search_24px.svg"></button>
            </form>
            <div id="apps">
                <div onclick="location.href='/home';" class="app" id="app-famiwiki">
                    <img src="/logos/familine/familine128.png" width="36px" height="36px" class="app-image" id="app-famiwiki-image"></img>
                    <span class="app-text" id="app-famiwiki-text">Familine</span>
                    <span class="app-tagline" id="app-famiwiki-tagline">Le réseau familial international, votre point d'accès à des milliers de ressources.</span>
                </div>

                <div onclick="location.href='https://facebook.com';" class="app" id="app-faminews">
                    <img src="facebook.png" width="36px" height="36px" class="app-image" id="app-faminews-image"></img>
                    <span class="app-text" id="app-faminews-text">Facebook</span>
                    <span class="app-tagline" id="app-faminews-tagline">Le réseau social que toute la famille utilise et qui respecte pas votre vie privée.</span>
                </div>

                <div onclick="location.href='https://familine.jetbrains.space';" class="app" id="app-famiprods">
                    <img src="space.svg" width="36px" height="36px" class="app-image" id="app-famiprods-image"></img>
                    <span class="app-text" id="app-famiprods-text">Space</span>
                    <span class="app-tagline" id="app-famiprods-tagline">Un nouveau réseau familial plus convivial et centralisé, disponible prochainement.</span>
                </div>

                <div onclick="location.href='https://plex.tv/web';" class="app" id="app-faminey">
                    <img src="plex.png" width="36px" height="36px" class="app-image" id="app-faminey-image"></img>
                    <span class="app-text" id="app-faminey-text">Plex</span>
                    <span class="app-tagline" id="app-faminey-tagline">Votre nouveau réseau pour regarder des productions de Famiprods et plus encore.</span>
                </div>

                <div onclick="location.href='https://famishare.ddns.net';" class="app" id="app-famipun">
                    <img src="famishare.svg" width="36px" height="36px" class="app-image" id="app-famipun-image"></img>
                    <span class="app-text" id="app-famipun-text">Famishare</span>
                    <span class="app-tagline" id="app-famipun-tagline">Partagez facilement et simplement du contenu avec tous vos proches, en toute sécurité.</span>
                </div>

                <!--<div onclick="location.href='/fcd';" class="app" id="app-chat">
                    <img src="/logos/cloud/cloud128.png" width="36px" height="36px" class="app-image" id="app-cloud-image"></img>
                    <span class="app-text" id="app-cloud-text">Editors Cloud</span>
                    <span class="app-tagline" id="app-cloud-tagline">Un espace de stockage privé, fiable et sécurisé. Stockez vos fichiers personnels et accédez-y depuis n'importe quel appareil.</span>
                </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (cnt <= 0) {
                        ...
                        document.getElementById('username').innerText = "Aucune nouvelle notification";
                    }
                    if (cnt == 1) {
                        document.title = "(1) " + ot;
                        ...
                        document.getElementById('username').innerText = "1 notification";
                    }
                    if (cnt > 1) {
                        ...
                        document.getElementById('username').innerText = cnt + " notifications";
                    }
                }
            });
        }
